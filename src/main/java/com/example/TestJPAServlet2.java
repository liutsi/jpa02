...
public class TestJPAServlet2 extends HttpServlet {
...
//            	MsgConfig123 visitor = (MsgConfig123)visitor2;
                out.println("<td>" + visitor2.getAssetName() + "</td>\n"); 
                out.println("<td>" + visitor2.getAssetId() + "</td>\n"); 
                out.println("<td>" + visitor2.getInstance() + "</td>\n"); 
                out.println("</tr>\n"); 
            }
            out.println("</tbody>\n"); 
            out.println("</table>\n"); 
